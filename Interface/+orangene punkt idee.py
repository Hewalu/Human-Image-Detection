...
# HIER IST DIE ÄNDERUNG: Float Wert für anteilige LEDs
ADD_LEDS_PER_PERSON = 0.5  # 3 Personen = ~1 LED
...
def draw_led_ring(screen, active_leds, total_leds, state, breathing_alpha=255, is_slow_mode=False, orange_count=0):
    ...
    for i in range(total_leds):
        ...
        if state == STATE_GREEN:
            ...
            # Modulo-Trick (12 Uhr verschwindet zuletzt)
...
def main():
    ...
    while running:
        ...
        # ZEIT-FAKTOR (Rote Phase beschleunigt mit Leuten)
            ...
            if timer_accumulator >= time_threshold:
                ...
                if current_state == STATE_GREEN:
                    ...
                    if led_counter > TOTAL_LEDS_RED:
                        ...
                        # --- HIER IST DIE BERECHNUNG MIT FLOAT ---
                        bonus_leds_float = person_count * ADD_LEDS_PER_PERSON
                        # Wir runden ab oder nutzen int(), je nach Wunsch. int() schneidet ab.
                        # Wenn du ab 3 Personen 1 LED willst (3 * 0.333 = 0.999 -> int = 0),
                        # dann müssen wir runden (round) oder addieren.
                        # Bei 0.333 und 3 Personen = 0.999. int() macht 0 daraus.
                        # Besser: round() nutzen.
